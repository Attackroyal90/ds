...
public class ServerProxy implements IProxy {
    @Override
    public void preInit() {
        // Code spécifique au serveur pour la phase de pré-initialisation
    }

    @Override
    public void init() {
        // Code spécifique au serveur pour la phase d'initialisation
    }

    @Override
    public void postInit() {
        // Code spécifique au serveur pour la phase de post-initialisation
    }
